    ...
    <>
      ...
      <section className="relative py-20 md:py-40 text-center text-white">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1509062522246-3755977927d7?ixlib=rb-4.0.3&w=1920&q=80')",
          }}
        />
          ...
          <div className="relative mb-8">
            ...
            <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-2xl md:rounded-3xl p-4 md:p-8 border border-white/30">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl mb-6 text-white font-serif font-semibold leading-relaxed break-words">
                Transform Learning Beyond Classrooms
              </h2>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="relative mb-16 text-center">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&w=1200&q=80')",
              }}
            />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="relative mb-16 text-center">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-4.0.3&w=1200&q=80')",
              }}
            />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="relative mb-16 text-center">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?ixlib=rb-4.0.3&w=1200&q=80')",
              }}
            />
      ...
      {/* Itinerary */}
      <section id="itinerary" className="py-20 bg-gray-100">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="relative mb-16 text-center">
            <div
              className="absolute inset-0 bg-cover bg-center rounded-2xl"
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="relative mb-16 text-center">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1531482615713-2afd69097998?ixlib=rb-4.0.3&w=1200&q=80')",
              }}
            />
