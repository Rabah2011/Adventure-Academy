    ...
    <>
      ...
      <section className="relative py-40 text-center text-white">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&w=1920&q=80')",
          }}
        />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="relative mb-16 text-center">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1481627834876-b7833e8f5570?ixlib=rb-4.0.3&w=1200&q=80')",
              }}
            />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="relative mb-16 text-center">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1522202176988-6b43f82c33c4?ixlib=rb-4.0.3&w=1200&q=80')",
              }}
            />
